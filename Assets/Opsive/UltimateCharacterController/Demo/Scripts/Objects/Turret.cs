...
namespace Opsive.UltimateCharacterController.Demo.Objects
{
    ...
    public class Turret : MonoBehaviour
    {
        ...
        {
            var targetRotation = Quaternion.Euler(Quaternion.LookRotation(m_TurretHead.position - m_Target.position).eulerAngles.x, Quaternion.LookRotation(m_TurretHead.position - m_Target.position).eulerAngles.y, 0);
